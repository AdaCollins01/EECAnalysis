    ...
    for(int iEnergyEnergyCorrelatorType = 0; iEnergyEnergyCorrelatorType < knEnergyEnergyCorrelatorTypes; iEnergyEnergyCorrelatorType++){
      for(int iJetPt = 0; iJetPt < kMaxJetPtBinsEEC; iJetPt++){
        for(int iTrackPt = 0; iTrackPt < kMaxTrackPtBinsEEC; iTrackPt++){
	     ...
	     fhEnergyEnergyEnergyCorrelatorFull[iEnergyEnergyCorrelatorType][iCentrality][iJetPt][iTrackPt][iPairingType][iSubevent] = NULL;
	     }
            } // Subevent loop
    ...
    for(int iEnergyEnergyCorrelatorType = 0; iEnergyEnergyCorrelatorType < knEnergyEnergyCorrelatorTypes; iEnergyEnergyCorrelatorType++){
      for(int iJetPt = 0; iJetPt < kMaxJetPtBinsEEC; iJetPt++){
        for(int iTrackPt = 0; iTrackPt < kMaxTrackPtBinsEEC; iTrackPt++){
	      ...
	      fhEnergyEnergyEnergyCorrelatorFullProcessed[iEnergyEnergyCorrelatorType][iCentrality][iJetPt][iTrackPt][iProcessingLevel] = NULL;
	      }
          } // Pairing type loop (same jet/reflected cone)
        } // Track pT bins for energy-energy correlators
      } // Jet pT bins for energy-energy correlators
    ...
    for(int iEnergyEnergyCorrelatorType = 0; iEnergyEnergyCorrelatorType < knEnergyEnergyCorrelatorTypes; iEnergyEnergyCorrelatorType++){
      for(int iJetPt = 0; iJetPt < kMaxJetPtBinsEEC; iJetPt++){
        for(int iTrackPt = 0; iTrackPt < kMaxTrackPtBinsEEC; iTrackPt++){
	      ...
	      fhEnergyEnergyEnergyCorrelatorFull[iEnergyEnergyCorrelatorType][iCentrality][iJetPt][iTrackPt][iPairingType][iSubevent] = in.fhEnergyEnergyEnergyCorrelatorFull[iEnergyEnergyCorrelatorType][iCentrality][iJetPt][iTrackPt][iPairingType][iSubevent];
              }
	    } // Subevent loop
          } // Pairing type loop
        } // Track pT bins for energy-energy correlators
    ...
    for(int iEnergyEnergyCorrelatorType = 0; iEnergyEnergyCorrelatorType < knEnergyEnergyCorrelatorTypes; iEnergyEnergyCorrelatorType++){
      for(int iJetPt = 0; iJetPt < kMaxJetPtBinsEEC; iJetPt++){
        for(int iTrackPt = 0; iTrackPt < kMaxTrackPtBinsEEC; iTrackPt++){
	      ...
	      fhEnergyEnergyEnergyCorrelatorFullProcessed[iEnergyEnergyCorrelatorType][iCentrality][iJetPt][iTrackPt][iProcessingLevel] = in.fhEnergyEnergyEnergyCorrelatorFullProcessed[iEnergyEnergyCorrelatorType][iCentrality][iJetPt][iTrackPt][iProcessingLevel];
              }
	  } // Pairing type loop (same jet/reflected cone)
        } // Track pT bins for energy-energy correlators
      } // Jet pT bins for energy-energy correlators
...
void EECHistogramManager::SubtractBackground(int iMethod, const int iSystematic){
  ...
  TH1D* rawHistogram;
  TH1D* signalFakeHistogram;
  TH1D* sameConeFakeFakeHistogram;
    ...
    for(int iCentrality = fFirstLoadedCentralityBin; iCentrality <= fLastLoadedCentralityBin; iCentrality++){
      ...
      for(int iTrackPt = fFirstLoadedTrackPtBinEEC; iTrackPt <= fLastLoadedTrackPtBinEEC; iTrackPt++){
        ...
        if(iMethod < 2){
          ...
          signalFakeHistogram = GetHistogramEnergyEnergyCorrelator(iEnergyEnergyCorrelatorType, iCentrality, fnJetPtBinsEEC, iTrackPt, EECHistograms::kSignalMixedConePair + 5*iMethod, EECHistograms::knSubeventCombinations);
          sameConeFakeFakeHistogram = GetHistogramEnergyEnergyCorrelator(iEnergyEnergyCorrelatorType, iCentrality, fnJetPtBinsEEC, iTrackPt, EECHistograms::kMixedConePair + 5*iMethod, EECHistograms::knSubeventCombinations);
          ...
          fhEnergyEnergyCorrelatorProcessed[iEnergyEnergyCorrelatorType][iCentrality][fnJetPtBinsEEC][iTrackPt][kEnergyEnergyCorrelatorBackground] = (TH1D*) signalFakeHistogram->Clone(Form("%s%s_C%dT%d",fEnergyEnergyCorrelatorHistogramNames[iEnergyEnergyCorrelatorType], fEnergyEnergyCorrelatorProcessedSaveString[kEnergyEnergyCorrelatorBackground], iCentrality, iTrackPt));
          fhEnergyEnergyCorrelatorProcessed[iEnergyEnergyCorrelatorType][iCentrality][fnJetPtBinsEEC][iTrackPt][kEnergyEnergyCorrelatorBackground]->Add(sameConeFakeFakeHistogram);
        ...
        // Reflected cone background subtraction method. In this method, background is estimated by placing another jet cone in the event with reflecting the eta-value. Around midrapidity, the jet cone is shifted by 2R instead of reflecting to avoid overlap of the cone. Particles from signal cone are paired with the reflected eta cone. We know from simulation that the shape of the background distribution is correct in case where fake+fake background is negligible. We can correct for the normalization of the background by MC-based scaling factor. This gives a good background subtraction in a kinematic region where fake+fake background is negligible.
          ...
          signalFakeHistogram = GetHistogramEnergyEnergyCorrelator(iEnergyEnergyCorrelatorType, iCentrality, fnJetPtBinsEEC, iTrackPt, EECHistograms::kSignalReflectedConePair, EECHistograms::knSubeventCombinations);
        ...
        for(int iJetPt = fFirstLoadedJetPtBinEEC; iJetPt <= fLastLoadedJetPtBinEEC; iJetPt++){
          ...
          if(iMethod < 2){
            ...
            signalFakeHistogram = GetHistogramEnergyEnergyCorrelator(iEnergyEnergyCorrelatorType, iCentrality, iJetPt, iTrackPt, EECHistograms::kSignalMixedConePair + 5*iMethod, EECHistograms::knSubeventCombinations);
            sameConeFakeFakeHistogram = GetHistogramEnergyEnergyCorrelator(iEnergyEnergyCorrelatorType, iCentrality, iJetPt, iTrackPt, EECHistograms::kMixedConePair + 5*iMethod, EECHistograms::knSubeventCombinations);
            ...
            fhEnergyEnergyCorrelatorProcessed[iEnergyEnergyCorrelatorType][iCentrality][iJetPt][iTrackPt][kEnergyEnergyCorrelatorBackground] = (TH1D*) signalFakeHistogram->Clone(Form("%s%s_C%dT%dJ%d",fEnergyEnergyCorrelatorHistogramNames[iEnergyEnergyCorrelatorType], fEnergyEnergyCorrelatorProcessedSaveString[kEnergyEnergyCorrelatorBackground], iCentrality, iTrackPt, iJetPt));
            fhEnergyEnergyCorrelatorProcessed[iEnergyEnergyCorrelatorType][iCentrality][iJetPt][iTrackPt][kEnergyEnergyCorrelatorBackground]->Add(sameConeFakeFakeHistogram);
          ...
          // Reflected cone background subtraction method. In this method, background is estimated by placing another jet cone in the event with reflecting the eta-value. Around midrapidity, the jet cone is shifted by 2R instead of reflecting to avoid overlap of the cone. Particles from signal cone are paired with the reflected eta cone. We know from simulation that the shape of the background distribution is correct in case where fake+fake background is negligible. We can correct for the normalization of the background by MC-based scaling factor. This gives a good background subtraction in a kinematic region where fake+fake background is negligible.
            ...
            signalFakeHistogram = GetHistogramEnergyEnergyCorrelator(iEnergyEnergyCorrelatorType, iCentrality, iJetPt, iTrackPt, EECHistograms::kSignalReflectedConePair, EECHistograms::knSubeventCombinations);
...
void EECHistogramManager::LoadHistograms(){
  ...
  // Load energy-energy-energy correlator unique and all histograms
...
/*
 * Loader for energy-energy-energy correlator unique and all histograms
 *
 ...
 *       Axis 5       Subevent combination        Only relevant for MC
 *       Axis 6        Energy weight index      Only present in new files
 *       Axis 7          Unique Flag       1 = unique triplet, 0 = degenerate
 */
void EECHistogramManager::LoadEnergyEnergyEnergyCorrelatorUniqueHistograms(){
  ...
  // Loop over all different energy-energy correlator histograms
  for(int iEnergyEnergyCorrelatorType = knEnergyEnergyCorrelatorTypes - 3; iEnergyEnergyCorrelatorType < knEnergyEnergyCorrelatorTypes - 1; iEnergyEnergyCorrelatorType++){  // Only want Unique and All
    if(!fLoadEnergyEnergyCorrelatorHistograms[iEnergyEnergyCorrelatorType]) continue;  // Only load the selected energy-energy correlators
   ...
   higherTrackPtBin = histogramArray->GetAxis(2)->GetNbins()+1;
    ...
    // We need this information in newer files to project the desired energy weight from the THnSparse
    // We also only need to restrict the axis if there are more than one bin.
    if(histogramArray->GetNdimensions() >= 8 && fCard->GetNWeightExponents() > 1){
      ...
      for(int iCentrality = fFirstLoadedCentralityBin; iCentrality <= fLastLoadedCentralityBin; iCentrality++){
       ...
       // Read the energy-energy correlator histograms without jet pT restrictions
          ...
          for(int iJetPt = fFirstLoadedJetPtBinEEC; iJetPt <= fLastLoadedJetPtBinEEC; iJetPt++){
            ...
            // Add restriction for jet pT axis (1 = jet pT)
            axisIndices[weightRestricted+4] = 1; 
            lowLimits[weightRestricted+4] = lowerJetPtBin; 
            highLimits[weightRestricted+4] = higherJetPtBin;
...
cout << "More than 0 entries!" << endl;
            ...
            if(fSystemAndEnergy.Contains("PbPb MC")){
              for(int iSubevent = 0; iSubevent < EECHistograms::knSubeventCombinations; iSubevent++){
                ...
                // Read the energy-energy correlator histograms
                fhEnergyEnergyEnergyCorrelatorUnique[iEnergyEnergyCorrelatorType][iCentrality][iJetPt][iTrackPt][iPairingType][iSubevent][iUniqueFlag] = FindHistogram(histogramArray, 0, 5+weightRestricted, axisIndices, lowLimits, highLimits);
	  ...
	  // For PbPb MC, write histograms without jet pT and with subevent type binning
          if(fSystemAndEnergy.Contains("PbPb MC")){
            for(int iSubevent = 0; iSubevent < EECHistograms::knSubeventCombinations; iSubevent++){
              ...
              if(fhEnergyEnergyCorrelator[iEnergyEnergyCorrelatorType][iCentrality][fnJetPtBinsEEC][iTrackPt][iPairingType][iSubevent]) fhEnergyEnergyCorrelator[iEnergyEnergyCorrelatorType][iCentrality][fnJetPtBinsEEC][iTrackPt][iPairingType][iSubevent]->Write(histogramNamer.Data(), TObject::kOverwrite); // Not worried about this for now 
	    ...
	    if(iEnergyEnergyCorrelatorType < 8){
            ...
            if(fSystemAndEnergy.Contains("PbPb MC")){
              for(int iSubevent = 0; iSubevent < EECHistograms::knSubeventCombinations; iSubevent++){
                ...
                if(fhEnergyEnergyCorrelator[iEnergyEnergyCorrelatorType][iCentrality][iJetPt][iTrackPt][iPairingType][iSubevent]) fhEnergyEnergyCorrelator[iEnergyEnergyCorrelatorType][iCentrality][iJetPt][iTrackPt][iPairingType][iSubevent]->Write(histogramNamer.Data(), TObject::kOverwrite); // Still not worried about this because we're not looping at PbPb
  ...
  for(int iEnergyEnergyCorrelatorType = 0; iEnergyEnergyCorrelatorType < knEnergyEnergyCorrelatorTypes; iEnergyEnergyCorrelatorType++){
    ...
    for(int iCentrality = fFirstLoadedCentralityBin; iCentrality <= fLastLoadedCentralityBin; iCentrality++){
	  ...
	  if(iEnergyEnergyCorrelatorType != 8){
          ...
          } // 1D energy correlator condition
	  else{
          	if(fhEnergyEnergyEnergyCorrelatorFullProcessed[iEnergyEnergyCorrelatorType][iCentrality][fnJetPtBinsEEC][iTrackPt][iProcessingLevel]) fhEnergyEnergyEnergyCorrelatorFullProcessed[iEnergyEnergyCorrelatorType][iCentrality][fnJetPtBinsEEC][iTrackPt][iProcessingLevel]->Write(nullptr, TObject::kOverwrite);
	  } // 2D energy correlator condition
        ...
        for(int iJetPt = fFirstLoadedJetPtBinEEC; iJetPt <= fLastLoadedJetPtBinEEC; iJetPt++){
	  	...
	  	if(fhEnergyEnergyEnergyCorrelatorFullProcessed[iEnergyEnergyCorrelatorType][iCentrality][iJetPt][iTrackPt][iProcessingLevel]) fhEnergyEnergyEnergyCorrelatorFullProcessed[iEnergyEnergyCorrelatorType][iCentrality][iJetPt][iTrackPt][iProcessingLevel]->Write(nullptr, TObject::kOverwrite);
            } // 2D energy correlator condition	
...
void EECHistogramManager::SetLoadEnergyEnergyEnergyCorrelators(const bool loadOrNot){
  ...
  fLoadEnergyEnergyCorrelatorHistograms[kEnergyEnergyEnergyCorrelatorUnique] = loadOrNot;
  fLoadEnergyEnergyCorrelatorHistograms[kEnergyEnergyEnergyCorrelatorAll] = loadOrNot;
...
// Getter for full energy-energy-energy correlator histograms
TH2D* EECHistogramManager::GetHistogramEnergyEnergyEnergyCorrelatorFull(const int iEnergyEnergyCorrelatorType, const int iCentrality, const int iJetPt, const int iTrackPt, const int iPairingType, const int iSubevent){
  ...
  if(fhEnergyEnergyEnergyCorrelatorFull[iEnergyEnergyCorrelatorType][iCentrality][iJetPt][iTrackPt][iPairingType][iSubevent] == NULL){
    ...
    fhEnergyEnergyEnergyCorrelatorFull[iEnergyEnergyCorrelatorType][iCentrality][iJetPt][iTrackPt][iPairingType][iSubevent] = (TH2D*) fInputFile->Get(histogramNamer.Data());
  ...
  return fhEnergyEnergyEnergyCorrelatorFull[iEnergyEnergyCorrelatorType][iCentrality][iJetPt][iTrackPt][iPairingType][iSubevent];
}
...
// Getter for processed full energy-energy-energy correlator histograms
TH2D* EECHistogramManager::GetHistogramEnergyEnergyEnergyCorrelatorFullProcessed(const int iEnergyEnergyCorrelatorType, const int iCentrality, const int iJetPt, const int iTrackPt, const int iProcessingLevel){

  // If the histogram is NULL, try to load it from the input file
  if(fhEnergyEnergyEnergyCorrelatorFullProcessed[iEnergyEnergyCorrelatorType][iCentrality][iJetPt][iTrackPt][iProcessingLevel] == NULL){
    TString histogramNamer = Form("%sProcessed/%s%s_C%dT%d",fEnergyEnergyCorrelatorHistogramNames[iEnergyEnergyCorrelatorType], fEnergyEnergyCorrelatorHistogramNames[iEnergyEnergyCorrelatorType], fEnergyEnergyCorrelatorProcessedSaveString[iProcessingLevel], iCentrality, iTrackPt);

    if(iJetPt != fnJetPtBinsEEC) histogramNamer.Append(Form("J%d", iJetPt));
    
    fhEnergyEnergyEnergyCorrelatorFullProcessed[iEnergyEnergyCorrelatorType][iCentrality][iJetPt][iTrackPt][iProcessingLevel] = (TH2D*) fInputFile->Get(histogramNamer.Data());
  }

  return fhEnergyEnergyEnergyCorrelatorFullProcessed[iEnergyEnergyCorrelatorType][iCentrality][iJetPt][iTrackPt][iProcessingLevel];
}
...
TH2D* EECHistogramManager::GetTwoDimensionalHistogram(TString name, int bin1, int bin2, int bin3, int bin4, int bin5){
  ...
  if(name.EqualTo("energyenergyenergycorrelatorfull",TString::kIgnoreCase) || name.EqualTo("fhenergyenergyenergycorrelatorfull",TString::kIgnoreCase) || name.EqualTo("eeec full",TString::kIgnoreCase)) return GetHistogramEnergyEnergyEnergyCorrelatorFull(bin1,bin2,bin3,bin4,bin5);
  if(name.EqualTo("energyenergyenergycorrelatorfullprocessed",TString::kIgnoreCase) || name.EqualTo("fhenergyenergyenergycorrelatorfullprocessed",TString::kIgnoreCase)) return GetHistogramEnergyEnergyEnergyCorrelatorFullProcessed(bin1,bin2,bin3,bin4,bin5);
 return NULL;
}
