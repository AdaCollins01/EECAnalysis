...
public:
 ...
 private:
  ...
  void helpFillEEECArray(double* array, double deltaR, double jetPt, double lowerTrackPt, double centrality, int iPairingType, int subeventCombination, int weightIndex); // Clean up filling energy-energy-energy correlator hists
  void helpFillEEECArray(double* array, double deltaR, double jetPt, double lowerTrackPt, double centrality, int iPairingType, int subeventCombination, int weightIndex, int uniqueFlag); // Clean up filling energy-energy-energy correlator unique and all hists
